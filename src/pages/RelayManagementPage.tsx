...
export function RelayManagementPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Relays List */}
      <div>
        <h2 className="font-bold mb-3">Your Relays ({relays.length})</h2>
        {relays.length === 0 ? (
      ...
      <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
        <h3 className="font-bold text-blue-600 mb-2">Default Relays</h3>
        <p className="text-sm text-blue-600/80">
          Your relay list is saved to Nostr as Kind 10002. This allows other clients to use your relay preferences.
        </p>
      </div>
    </div>
  );
